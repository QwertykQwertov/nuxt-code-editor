<template>
  <!DOCTYPE html>
  <div class="dark dark:bg-gray-800 flex flex-col min-h-screen">
    <header
    ...
    >
      <div class="container flex items-center justify-between gap-x-10">
        <a href="#" class="flex items-center gap-x-1 sm:gap-x-2">
          ...
          <span class="text-xl sm:text-2xl font-black dark:text-white"
            >Code Editor</span
          >
        </a>
        <nav class="hidden sm:block grow">
          <ul class="flex items-center gap-x-8">
            ...
            <li>
              <a
                href="#"
                class="px-3 py-2 font-semibold rounded-md bg-indigo-600 text-indigo-50 hover:bg-indigo-700"
              >
                Sign Up
              </a>
            </li>
        ...
        <div class="flex sm:hidden">
          ...
          <a
            href="#"
            class="hidden p-2 hover:bg-gray-100 rounded-md -mr-1.5 dark:hover:bg-gray-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
    ...
    <main>
        ...
        >
          ...
          >
            ...
            <div class="mt-6 flex gap-x-2 sm:mt-8">
              <a
                href="#"
                class="px-6 py-2 font-semibold rounded-md bg-indigo-600 text-indigo-50 hover:bg-indigo-700 sm:px-8 sm:py-3 sm:text-lg sm:rounded-lg"
                >Explore</a
              >
              <a
                href="#features"
          ...
          <div
            class="relative scale-90 lg:scale-110 lg:w-2/3 lg:perspective-distant"
          >
      ...
      <section
        class="flex flex-col py-8 gap-y-8 bg-gray-50 sm:py-16 sm:gap-y-12 dark:bg-gray-700"
        id="features"
      >
        <div class="container max-w-screen-sm">
          <h2
            class="text-2xl font-bold text-center sm:text-4xl dark:text-white"
          >
        ...
        <div class="container grid gap-4 lg:grid-cols-3 lg:gap-8">
          <a href="#">
            ...
            >
              ...
              <p
                class="text-gray-600 mt-1 text-sm sm:text-base dark:text-gray-400"
              >
      ...
      <section class="flex flex-col gap-y-6 py-8 sm:gap-y-8 sm:py-16">
        ...
        <div class="container">
          <form class="flex justify-center gap-x-2">
            ...
            />
            <button
              class="cursor-pointer px-4 py-1 font-semibold rounded-md bg-indigo-600 text-indigo-50 hover:bg-indigo-700 sm:px-6 sm:py-2 sm:rounded-lg"
            >
        ...
        <div class="flex flex-col gap-10 lg:gap-8 lg:flex-row">
          ...
          <div class="flex flex-col gap-y-8 sm:gap-x-16 sm:flex-row">
            <div class="flex flex-col gap-y-3 sm:gap-y-4">
              <h3
                class="font-semibold text-sm uppercase tracking-wider text-white"
              >
                Popular Playlists
              </h3>
